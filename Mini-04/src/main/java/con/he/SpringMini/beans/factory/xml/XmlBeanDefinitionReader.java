package con.he.SpringMini.beans.factory.xml;
...
import con.he.SpringMini.beans.factory.support.AbstractBeanDefinitionReader;
import con.he.SpringMini.beans.factory.support.BeanDefinitionRegistry;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            beanDefinition.setDestoryMethodName(destoryMethod);
